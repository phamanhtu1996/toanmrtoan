...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/skills/progressbar.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/skills/style.css">
        <!--<link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/navmenu/styles.css">-->
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/portfolio.jquery.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/fonticons.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/style.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/fonts/stylesheet.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/font-awesome.min.css">
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/bootstrap.min.css">
        <!--        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/bootstrap-theme.min.css">-->


        <!--For Plugins external css-->
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/teamslide.css" />
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/plugins.css" />

        <!--Theme custom css -->
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/style.css">

        <!--Theme Responsive css-->
        <link rel="stylesheet" href="<?=public_url("frontend/assets")?>/css/responsive.css" />

        <script src="<?=public_url("frontend/assets")?>/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
                ...
                <div class="row">
                    ...
                    <div class="main_service_area sections text-center">
                        ...
                        <div class="col-sm-4">
                            <div class="single_service">
                                <div class="single_service_icon">
                                    <img src="<?=public_url("frontend/assets")?>/images/service.png" alt="" />
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="single_service">
                                <div class="single_service_icon">
                                    <img src="<?=public_url("frontend/assets")?>/images/service2.png" alt="" />
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="single_service">
                                <div class="single_service_icon">
                                    <img src="<?=public_url("frontend/assets")?>/images/service3.png" alt="" />
                                </div>
                        ...
                        <div class="main_choose_content">
                            <div class="single_choose_content">
                                <div class="singel_choose_img">
                                    <img src="<?=public_url("frontend/assets")?>/images/choose.png" alt="" />
                                </div>
                        ...
                        <div id="mixcontent" class="mixcontent">
                            <div class="col-md-4 mix cat1 no-padding">
                                <div class="single_mixi_portfolio">
                                    <img src="<?=public_url("frontend/assets")?>/images/pf1.jpg" alt="" />
                            ...
                            <div class="col-md-4 mix cat2 no-padding">
                                <div class="single_mixi_portfolio">
                                    <img src="<?=public_url("frontend/assets")?>/images/pf2.jpg" alt="" />
                                    <div class="mixi_portfolio_overlay">
                                        <div class="overflow_hover_text">
                                            <h2>INGREDIENTS</h2>
                                            <p>ARE IMPORTANT FOR COOKING ?</p>
                            ...
                            <div class="col-md-4 mix cat1 cat4 no-padding">
                                <div class="single_mixi_portfolio">
                                    <img src="<?=public_url("frontend/assets")?>/images/pf3.jpg" alt="" />
                                    <div class="mixi_portfolio_overlay">
                                        <div class="overflow_hover_text">
                                            <h2>INGREDIENTS</h2>
                                            <p>ARE IMPORTANT FOR COOKING ?</p>
                            ...
                            <div class="col-md-4 mix cat3 cat4 no-padding">
                                <div class="single_mixi_portfolio">
                                    <img src="<?=public_url("frontend/assets")?>/images/pf4.jpg" alt="" />
                                    <div class="mixi_portfolio_overlay">
                                        <div class="overflow_hover_text">
                                            <h2>INGREDIENTS</h2>
                                            <p>ARE IMPORTANT FOR COOKING ?</p>
                            ...
                            <div class="col-md-4 mix cat4 no-padding">
                                <div class="single_mixi_portfolio">
                                    <img src="<?=public_url("frontend/assets")?>/images/pf5.jpg" alt="" />
                                    <div class="mixi_portfolio_overlay">
                                        <div class="overflow_hover_text">
                                            <h2>INGREDIENTS</h2>
                                            <p>ARE IMPORTANT FOR COOKING ?</p>
                    ...
                    <div class="main_about sections">
                        ...
                        <div class="main_about_content_area">
                            <div class="single_about_left_img">
                                <img src="<?=public_url("frontend/assets")?>/images/ab.jpg" alt="" />
                            </div> 
                                ...
                                <div class="single_about_right_content">
                                    <div class="demo4">
                                        <div class="right_single_about_skill">
                                            <div class="right_about_top_cotent">
                                                <div class="right_about_top_img">
                                                    <img src="<?=public_url("frontend/assets")?>/images/s_ab1.png" alt="" />
                                                </div>
                                        ...
                                        <div class="right_single_about_skill">
                                            <div class="right_about_top_cotent">
                                                <div class="right_about_top_img">
                                                    <img src="<?=public_url("frontend/assets")?>/images/s_ab2.png" alt="" />
                                                </div>
                                                <div class="right_about_top_content">
                                                    <h3>COOKCING BOOK</h3>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consectetur convallis nunc, 
                                        ...
                                        <div class="right_single_about_skill">
                                            <div class="right_about_top_cotent">
                                                <div class="right_about_top_img">
                                                    <img src="<?=public_url("frontend/assets")?>/images/s_ab3.png" alt="" />
                                                </div>
                                                <div class="right_about_top_content">
                                                    <h3>COOKCING BOOK</h3>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consectetur convallis nunc, 
                            ...
                            <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#quote-carousel" data-slide-to="0" class="active">
                                        <img class="img-responsive " src="<?=public_url("frontend/assets")?>/images/team1.jpg" alt="">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    ...
                                    <div class="footer_gellary">
                                        <img src="<?=public_url("frontend/assets")?>/images/fg1.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg2.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg3.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg4.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg5.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg6.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg7.jpg" alt="" />
                                        <img src="<?=public_url("frontend/assets")?>/images/fg8.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    <div class="footer_logo">
                                        <img src="<?=public_url("frontend/assets")?>/images/footerlogo.png" alt="" />
                                    </div>
